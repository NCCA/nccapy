...
class TestObj(unittest.TestCase):
    ...
    def test_build_obj_with_colour(self):
        obj = Obj()
    ...
    def test_obj_with_colour(self):
        obj = Obj.from_file("tests/files/TriColour.obj")
        self.assertTrue(hasattr(obj, "colour"))
        self.assertEqual(obj.colour[0], Vec3(1.0, 0.0, 0.0))
        self.assertEqual(obj.colour[1], Vec3(0.0, 1.0, 0.0))
        self.assertEqual(obj.colour[2], Vec3(0.0, 0.0, 1.0))
